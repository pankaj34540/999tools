          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 mb-6 text-left">
            <div className="flex items-start gap-2">
              ...
              <p className="text-[11px] text-amber-900 leading-relaxed">
                <strong>Verification Time:</strong> 2-24 hours. Aapko notification milega jab plan activate ho jayega. Koi doubt ho toh: {siteConfig.supportPhone}
              </p>
            </div>
          </div>
    ...
    <div className="fixed inset-0 z-[80] bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white rounded-3xl max-w-lg w-full p-6 sm:p-8 shadow-2xl border border-slate-200 relative my-8">
        ...
        <button
          onClick={handleClose}
          disabled={loading}
          className="absolute top-4 right-4 w-9 h-9 rounded-full bg-slate-100 text-slate-400 hover:text-slate-600 flex items-center justify-center font-bold disabled:opacity-50"
        >
          <X className="w-5 h-5" />
        </button>
